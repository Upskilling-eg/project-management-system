...
console.log(userRole);
  ...
  return (
    ...
    <div className="sidebar-container">
      ...
      <Modal show={show} onHide={handleClose} size="lg" className="custom-model">
      ...
      <Sidebar className="vh-100" collapsed={isCollapsed}>
        <div className={`toggle-sidebar-btn ${isCollapsed ? 'collapsed' : ''} `} onClick={handleToggle}>
          {isCollapsed ? <i className="fa-solid fa-arrow-right" />
